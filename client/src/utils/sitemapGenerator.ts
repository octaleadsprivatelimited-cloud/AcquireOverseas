...
export const generateSitemap = (): string => {
  ...
  const urls: SitemapUrl[] = [
    ...
    { loc: '/about-us', lastmod: currentDate, changefreq: 'monthly', priority: 0.8 },
    ...
    { loc: '/study-visa', lastmod: currentDate, changefreq: 'monthly', priority: 0.9 },
    ...
    { loc: '/immigration-consultation', lastmod: currentDate, changefreq: 'monthly', priority: 0.8 },
